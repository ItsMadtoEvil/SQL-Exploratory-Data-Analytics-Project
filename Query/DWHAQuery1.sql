...
FROM 'F:\Data Science Projects\Data Warehouse project\sql-data-warehouse-project\Results\gold.dim_customers.csv'
WITH (
    FIRSTROW = 2,
    FIELDTERMINATOR = ',',
    TABLOCK
...
FROM 'F:\Data Science Projects\Data Warehouse project\sql-data-warehouse-project\Results\gold.dim_products.csv'
WITH (
    FIRSTROW = 2,
    FIELDTERMINATOR = ',',
    TABLOCK
...
FROM 'F:\Data Science Projects\Data Warehouse project\sql-data-warehouse-project\Results\gold.fact_sales.csv'
WITH (
    FIRSTROW = 2,
    FIELDTERMINATOR = ',',
    TABLOCK
